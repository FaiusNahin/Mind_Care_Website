    ...
    return (
        <div style={{ backgroundColor: 'rgb(80 80 80)' }}>
            <Container className="pt-5 pb-4">
                <Row lg={4} md={2} sm={1} className="py-4 px-4 gy-md-5 d-flex align-items-center">
                    ...
                    <Col lg={3} md={6} sm={12} className="pb-5 d-flex flex-column align-items-start align-items-md-center">
                        <div className="d-flex flex-column align-items-start">
                            ...
                            <div >
                                <p className="mb-2"><a href="" className="text-decoration-none text-white-50">Depression therapy</a></p>
                                <p className="mb-2"><a href="" className="text-decoration-none text-white-50">Individual therapy</a></p>
                                <p className="mb-2"><a href="" className="text-decoration-none text-white-50">Couples therapy</a></p>
                                <p className="mb-2"><a href="" className="text-decoration-none text-white-50">Children therapy</a></p>
                                <p className="mb-2"><a href="" className="text-decoration-none text-white-50">Pre-divorce therapy</a></p>
                            </div>
                        </div>
                    </Col>

                    <Col lg={3} md={6} sm={12} className="pb-5 pb-5 d-flex flex-column align-items-center">
                        <div className="d-flex flex-column align-items-start">
                    ...
                    <Col lg={3} md={6} sm={12} className="pb-5">
                        ...
                        <Row lg={3} md={3} sm={1} className="g-3">
                            <Col lg={4} md={4} sm={12}>
